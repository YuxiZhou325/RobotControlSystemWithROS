    ...
    def class_defuzzification(self, sensor_membership_values):
        ...
        for rule in self.rule_base.rules:
            ...
            if fs > 0:
                ...
                rule_speed.append(self.class_speed_centre_set[rule.consequents[0]])
                rule_steer.append(self.class_steer_centre_set[rule.consequents[1]])
